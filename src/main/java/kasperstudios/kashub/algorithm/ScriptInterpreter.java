...
public class ScriptInterpreter {
    ...
    private ScriptInterpreter() {
        try {
            ...
            LOGGER.warn("Failed to initialize environment variables (likely test env): " + e.getMessage());
        }
    }
    ...
    private void initializeEnvironmentVariables() {
        ...
        environmentVariables.put("PLAYER_PITCH",
                new EnvironmentVariable("PLAYER_PITCH", "", "Player vertical rotation"));
        ...
        environmentVariables.put("WORLD_DIFFICULTY",
                new EnvironmentVariable("WORLD_DIFFICULTY", "", "World difficulty"));
    ...
    public void updateEnvironmentVariables() {
        ...
        if (mc != null && mc.player != null && mc.world != null) {
            ...
            updateEnvVar("WORLD_WEATHER",
                    mc.world.isRaining() ? (mc.world.isThundering() ? "thunder" : "rain") : "clear");
            ...
            if (!line.isEmpty() && !line.startsWith("//")) {
                try {
                    ...
                    if (whileMatcher.find()) {
                        String condition = whileMatcher.group(1) != null ? whileMatcher.group(1)
                                : whileMatcher.group(2);
    ...
    private int processIfElseBlock(String[] lines, int startIndex, Matcher ifMatcher, List<Command> commands) {
        ...
        while (i < lines.length && blockLevel > 0) {
            ...
            if (blockLevel == 1
                    && (ELSE_PATTERN.matcher(blockLine).find() || ELSE_IF_PATTERN.matcher(blockLine).find())) {
                break;
            }
